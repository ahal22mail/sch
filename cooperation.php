  ...
  <!-- Menu -->
    <main class="d-flex flex-nowrap">
        ...
        <div class="container-fluid overflow-auto">
          ...
          <p class="pfont" style="text-align:left; margin-left:10px;">Hyzmatdaşlar</p>
            ...
            foreach ($json as $key => $value) 
            {
                ...
                else if($value["type"]=="4")
                {
                    ...
                    echo '<tr>
                            ...
                            <td> '.$value["name"].'</td>
                            <td>
                                <h4 style="margin-top:0px;"><img src="assets/cooperation/'.$value["image"].'" style="object-fit:contain;height:200px;width:300px;" alt="Hyzmatdaş" height="200" width="300" ></h4></div>
                            </td>

                            <td><a href="cooperation_delete.php?id='.$key.'">'.$key.'-Poz</a></td>
                        </tr>';
                    $i++;
                }
            }
    ...
    <form action="cooperation_add.php" method="post" enctype="multipart/form-data">
